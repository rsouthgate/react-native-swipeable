  ...
  render() {
    ...
    return (
      <View onLayout={this._handleLayout} style={[styles.container, style]} {...this._panResponder.panHandlers} {...props}>
        {canSwipeRight && (
          <Animated.View style={[{ transform, marginLeft: -width, width, zIndex: 1 }, leftContainerStyle]}>
        ...
        {canSwipeLeft && (
          <Animated.View style={[{ transform, marginRight: -width, width, zIndex: 1 }, rightContainerStyle]}>
